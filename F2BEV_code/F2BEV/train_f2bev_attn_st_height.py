...
bev_dirs = ['./data/images'+str(i)+'/train/depth' for i in range(num_data_sequences)]
...
vbev_dirs = ['./data/images'+str(i)+'/val/depth' for i in range(num_data_sequences)]
