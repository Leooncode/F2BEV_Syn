...
class FisheyeBEVFormer(nn.Module):
    ...
    def forward(self,front,left,rear,right,can_buses,prev_bev=None):      
        ...
        # mlvl_0 torch.Size([1, 4, 256, 135, 160])
        # mlvl_1 torch.Size([1, 4, 256, 68, 80])
        # mlvl_2 torch.Size([1, 4, 256, 34, 40])
        # mlvl_3 torch.Size([1, 4, 256, 17, 20])
        # torch.Size([1, 2500, 256])
        bevfeatures = self.encoder(mlvl_feats,can_buses,prev_bev)
        
        # torch.Size([1, 16, 400, 400])
